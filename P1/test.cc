...
const char *dbfile_dir = "/root/DIS/"; // dir where binary heap files should be stored
const char *tpch_dir ="/root/DIS/P1/"; // dir where dbgen tpch files (extension *.tbl) can be found
const char *catalog_path = "/root/DIS/P1/catalog"; // full path of the catalog file
